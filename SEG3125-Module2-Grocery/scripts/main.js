...
import {restrictListProducts,getTotalPrice} from "./groceries.js";


document.getElementById('clientTab').addEventListener('click', event => openInfo(event, 'Client'));
document.getElementById('productTab').addEventListener('click', event => openInfo(event, 'Products'));
document.getElementById('cartTab').addEventListener('click', event => openInfo(event, 'Cart'));
